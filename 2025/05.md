...
## 2025-05-31: GitHub Copilotを使ったTDDについて

### そもそもテストとは？

Ensuring our code does what we expect it to do.

### なぜテストを書くのか？

- Ensures code is working as expected
- Without testing, how do we know the code works?
- Tests show if any new code has broken existing code

### テストの種類

- Acceptance test
  - Testing app meets certain functionality
- Integration test
  - Testing app communication among various systems
- Unit test
  - Testing small units of code

### TDDとは？

Allowing the tests to drive how and what we develop as we are writing our code.
...
- Document tests
  ...
  - Add comments to explain complex tests
- Keep your tests organized
  - Group related tests together
  - Use folders or files to separate different test types
- Create utilities
