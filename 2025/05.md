...
従来のgraphql-tagと比較して、IDE補完や型エラー検出が強力で、開発体験が大きく向上する。

また、gql.tadaは1年ほど前にYouTubeでも紹介されており、最近はApolloやRelay以外のプロジェクトでも採用例が増えている印象。

実際に書いてみると、以下のように型安全なスキーマ定義ができる：
...
gql.tadaの導入で、スキーマやクエリの型エラーを事前に検出できるため、運用時のバグも減らせそう。

今後はApollo Clientや他のGraphQLクライアントと組み合わせて、より型安全な開発を進めていきたい。
