...
ツールとしてのAIを使いこなすため以上に、人間とAIの協働を通じて、より良い成果を出すための能力。

目的としては、AI技術の進化にもついていける、生き残れるスキルを身につけること。

### AI Fluencyを形作る"4D"要素

- Delegation (委任) : AIにタスクを任せる能力。AIの得意なことを理解し、適切にタスクを割り当てる。
- Description (記述) : AIに指示を出す能力。明確で具体的な指示を与え、期待する結果を得る。
- Discernment (識別) : AIの出力を評価する能力。AIの回答が正確か、信頼できるかを判断する。
- Diligence (勤勉) : AIとの協働を継続的に改善する能力。AIの学習やフィードバックを活用し、より良い結果を追求する。

### 自分自身の振り返り

- What challenges have you encountered when working with AI to achieve specific outcomes?
  - どんな場面でAIを使うのかを見極めるのに迷うことがある。まだAIに任せるべきタスクとそうでないタスクの線引きが曖昧
  - AIを利用したワークフローが確率されておらず、探り探り進めている状態。悩みが明確になったらAIに相談するイメージ
- What possibilities for AI collaboration excite you most?
  - 自分自身のアイデアの具現化がしやすくなる。AIと協働することでより早く多くのアウトプットが出せる
- What do you hope to gain from this course?
  - AIを使いこなすための基礎的なスキルを身につけたい。特に、AIとのコミュニケーションや協働の方法を学びたい
  - どんな場面でAIを使うのかをより明確にし、AIを活用したワークフローを確立したい
...
## 2025-06-18: AWS 14 days - Day 3 (その２)
...
graph TD
  ...
  RT["Route Table"]
  subA["Subnet (ap-northwest-1a)"]
  subC["Subnet (ap-northwest-1c)"]
  EC2A["EC2 (Web) ap-northwest-1a"]
  EC2C["EC2 (Web) ap-northwest-1c"]
