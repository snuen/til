...
## 2025-06-26: AWS 14 days - Day 4 (2)

ネットワーク関連の設計のポイントをまとめる。

### VPC / サブネットの広さ

- 将来を意識して 適切な 広さに設計する
- 今後、どれくらい Private IP アドレスが必要？を考える
- 基本的には余裕をもって大きめに（あとで広げることもできるが…）
- 一方で、むやみに広げればいいというわけでもない
- AWS サービスが IP アドレスを幾つ使いうるかを把握 する
